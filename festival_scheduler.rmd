...
# 2015-07-27: added splitting of table structure into non-redundant sets for processing
...
# assemble output table convertinf date/times to strings & scores to percent
tab<-with(gigs
         ,data.frame(band
